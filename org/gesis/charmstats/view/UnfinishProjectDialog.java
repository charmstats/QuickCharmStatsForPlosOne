...
/**
 * former UnpublishProjectContainer
 * 
 * @author	Martin Friedrichs
 * @since	0.9.6
 *
 */
public class UnfinishProjectDialog  extends JFrame implements FocusListener {
	...
	public static final String UPC_TITLE			= "upc_title";
	
	public static final String UPC_ACCEPT			= "upc_accept";
	public static final String UPC_CANCEL			= "tsv_cancel";
	public static final String UPC_HELP				= "tsv_help";
	public static final String UPC_NO_HELP			= "omc_no_help";
	
	public static final String UPC_PROJECT_LBL		= "upc_project_lbl";
	public static final String UNPUBLISH_PROJECT	= "UnpublishProject";
	 ...
	 * @param f
	 */
	UnfinishProjectDialog(List<Project> projects, Locale locale, Font f, ActionListener al) {
		unpublishProject(projects, locale, f, al);
	}
	 ...
	 * @param f
	 */
	private void unpublishProject(List<Project> projects, Locale locale, Font f, ActionListener al) {
		...
		callHelpBtn.setActionCommand(ActionCommandText.CMD_HELP_HELP_REVOKE_FINISHING);
		...
		this.setTitle(resourceBundle.getString(UPC_TITLE));
		...
		JLabel projectsLbl = new JLabel(resourceBundle.getString(UPC_PROJECT_LBL));
		...
		final String[] DIALOG_BUTTONS_TITLES	= {resourceBundle.getString(UPC_ACCEPT), resourceBundle.getString(UPC_CANCEL), resourceBundle.getString(UPC_HELP)};
	  	...
	  	while (retValue == 2) 
	   	{
	  		retValue = JOptionPane.showOptionDialog(		
    			null, 
    			formular,
    			resourceBundle.getString(UPC_TITLE),
    ...
    private void projectsCBActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	if (evt.getSource() instanceof JComboBox) {
    		...
    		if (object instanceof Project) {
				...
				String tooltip = "<html><B>"+prjTitel+"</B><BR>"+ prjAbstract +"<hr />"+ resourceBundle.getString(FP_TARGET_VARIABLE)+varName +" / \""+ varLabel +"\"<hr />"+ resourceBundle.getString(FP_CONCEPT) +" \""+ conName +"\""+ conDefinition +"</html>";
    			
				projectNote.setText(tooltip); 
    		}
    	}
    }
