 ...
 *
 */
public class OpenMeasureDialog extends JFrame implements FocusListener {
	...
	public static final String OMC_TITLE			= "omc_title";
	
	public static final String OMC_ACCEPT			= "omc_accept";
	public static final String OMC_CANCEL			= "omc_cancel";
	public static final String OMC_HELP				= "omc_help";
	public static final String OMC_NO_HELP			= "omc_no_help";
	 ...
	 * @param f
	 */
	OpenMeasureDialog(List<Measurement> measures, Locale locale, Font f, ActionListener al) {
		openMeasure(measures, locale, f, al);
	}
	 ...
	 * @param f
	 */
	private void openMeasure(List<Measurement> measures, Locale locale, Font f, ActionListener al) {
		...
		callHelpBtn.setActionCommand(ActionCommandText.CMD_HELP_HELP_OPEN_MEASUREMENT);
		...
		this.setTitle(resourceBundle.getString(OMC_TITLE));
		...
		final String[] DIALOG_BUTTONS_TITLES	= {resourceBundle.getString(OMC_ACCEPT), resourceBundle.getString(OMC_CANCEL), resourceBundle.getString(OMC_HELP)};
	  	...
	  	while (retValue == 2) 
	   	{
	  		retValue = JOptionPane.showOptionDialog(		
    			...
    			formular,
    			resourceBundle.getString(OMC_TITLE),
	 ...
	 * @return
	 */
	public Measurement getChosenMeasure() {
