 ...
 *
 */
public class OpenVariableDialog extends JFrame implements FocusListener {
	...
	public static final String OVC_TITLE			= "ovc_title";
	
	public static final String OVC_ACCEPT			= "omc_accept";
	 ...
	 * @param f
	 */
	OpenVariableDialog(List<Variable> variables, Locale locale, Font f, ActionListener al) {
		openVariable(variables, locale, f, al);
	}
	 ...
	 * @param f
	 */
	private void openVariable(List<Variable> variables, Locale locale, Font f, ActionListener al) {
		...
		this.setTitle(resourceBundle.getString(OVC_TITLE));
		...
		final String[] DIALOG_BUTTONS_TITLES	= {resourceBundle.getString(OVC_ACCEPT), resourceBundle.getString(OVC_CANCEL), resourceBundle.getString(OVC_HELP)};
	  	...
	  	while (retValue == 2) 
	   	{
	  		retValue = JOptionPane.showOptionDialog(		
    			...
    			formular,
    			resourceBundle.getString(OVC_TITLE),
