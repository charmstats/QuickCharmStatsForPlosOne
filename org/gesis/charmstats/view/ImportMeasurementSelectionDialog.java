 ...
 *
 */
public class ImportMeasurementSelectionDialog extends JDialog {
	...
	public static final String DIALOG_TITLE			= "dia_imp_mea_tit";
	...
	ArrayList<Measurement>		selection		= new ArrayList<Measurement>();
	 ...
	 * @param f
	 */
	public ImportMeasurementSelectionDialog(java.awt.Frame parent, boolean modal, List<Measurement> measures, CStatsModel model, Locale locale, Font f) {
		super(parent, EMPTY_TITLE, modal);
		
		currentLocale	= locale;
		resourceBundle	= ResourceBundle.getBundle(BUNDLE, currentLocale);
						
		initComponents(measures, f);		
	}
	 ...
	 * @param f
	 */
	private void initComponents(List<Measurement> measures, Font f) {
        ...
        /* Show list of measures: */
        Iterator<Measurement> iter = measures.iterator();
        while (iter.hasNext()) {
        	...
        	checkBox.setFont(f);
        	panel.add(checkBox);
        	JLabel contentLbl = new JLabel(mea.getName() +" ("+ mea.getLabel() +")");
    	...
    	this.addWindowListener(new java.awt.event.WindowAdapter() {
    	    ...
    	    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
				...
				while (iter.hasNext()) {
					...
					Measurement	value	= (Measurement)iter.next();
				}
	 ...
	 * @return
	 */
	public ArrayList<Measurement> getSelections() {
		Iterator<Object> iter = panelList.iterator();
		while (iter.hasNext()) {
			JCheckBox	key		= (JCheckBox)iter.next();
			Measurement	value	= (Measurement)iter.next();
