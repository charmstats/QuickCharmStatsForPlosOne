 ...
 *
 */
public class SpecificationView extends VertexView {
	...
	static SpecificationRenderer renderer = new SpecificationRenderer();
	
	/**
	 * @param cell
	 */
	public SpecificationView (Object cell) {
		super (cell);
	}
	...
	public static class SpecificationRenderer extends VertexRenderer {
		...
		public void paint(Graphics g) {
			...
			if (super.isOpaque()) {
				...
				if (gradientColor != null && !preview) {
					...
					g2.setPaint(new GradientPaint(0, 0, getBackground(),
							getWidth(), getWidth(), gradientColor, true));
				}
				g.fillOval(b - 1, b - 1, d.width - b, d.width - b);
			}
			try {
				setBorder(null);
				setOpaque(false);
			...
			if (bordercolor != null) {
				...
				g.drawOval(b - 1, b - 1, d.width - b, d.width - b);
			}
			if (selected) {
