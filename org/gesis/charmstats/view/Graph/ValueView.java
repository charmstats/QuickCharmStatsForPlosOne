 ...
 *
 */
public class ValueView extends VertexView{
	...
	static ValueRenderer renderer = new ValueRenderer();
	
	/**
	 * @param cell
	 */
	public ValueView (Object cell) {
		super (cell);
	}
	...
	static class ValueRenderer extends VertexRenderer {
